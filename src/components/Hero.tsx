...
const Hero = () => {
  return (
    <div className="relative overflow-hidden pt-28 md:pt-32 pb-16">
      {/* Background gradient */}
          ...
          <div className="relative">
            <div className="relative h-[400px] md:h-[480px] bg-white rounded-xl shadow-lg overflow-hidden card-shine">
              <div className="absolute inset-0 flex items-center justify-center">
                <img 
                  src="https://images.unsplash.com/photo-1492707892479-7bc8d5a4ee93?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&q=80" 
            ...
            {/* Floating element */}
            <div className="absolute -top-6 -right-6 w-28 h-28 rounded-lg bg-fashion-softGray shadow-md p-3 flex flex-col justify-center items-center animate-float">
            ...
            <div className="absolute -bottom-6 -left-6 w-28 h-28 rounded-lg bg-fashion-softGray shadow-md p-3 flex flex-col justify-center items-center animate-float animation-delay-1000">
